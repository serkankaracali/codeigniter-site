	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
	    <div class="container">
	      <a class="navbar-brand font-weight-bold" href="">
	        <img src="img/teklifceptepin.svg" height="55" width="75" class="logo" alt="a">Teklif Cepte
	      </a>
	      ...
	      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	        <ul class="navbar-nav ml-auto ">
	            <a class="nav-link font-weight-bold text-dark" href="">Ana Sayfa</a>
	            <a class="nav-link font-weight-bold text-dark" href="">Acenteler</a>
	            <a class="nav-link font-weight-bold text-dark" href="">Teklif Al</a>
	        </ul>
...
Ücretsiz Teklif Almak İçin Ürün Seçiniz !</p>
		    <div class="row">
          	...
          	<div class="text-center text-white">
							<a href="">
								<img src="img/trafik.png" style="width:256px;height:256px;" class="logo" alt="a">
							</a>
		      ...
		      <div class="col-md-3">
		          <div class="text-center text-white">
								<a href="">
					        <img src="img/kasko.png" style="width:256px;height:256px;" class="logo" alt="a">
					      </a>
		      ...
		      <div class="col-md-3">
		          ...
		          <div class="text-center text-white">
								<a href="">
					        <img src="img/dask.png" style="width:256px;height:256px;" class="logo" alt="a">
					      </a>
		          ...
		          <div class="text-center text-white">
								<a href="">
					        <img src="img/seyahat.png" style="width:256px;height:256px;" class="logo" alt="a">
					      </a>
