                ...
                <div class="form-group mb-2">
                    ...
                    <input maxlength="100" type="email" required class="form-control" placeholder="ornek@example.com" />
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input maxlength="100" type="text" required class="form-control" placeholder="Mesleğiniz" />
                        </div>
                        <div class="form-group mb-2">
                            <label class="control-label">Aracınıza kasko da yaptırmak istiyormusunuz?</label>
